...
def process_images(
    ...
    imags = [normalize(image, mean=image_mean, std = image_std) for image in images]
...
class PaliGemmaProcessor:
    ...
    def __init__(self, tokenizer, num_image_tokens: int, image_size: int):
        ...
        ] # these tokens are for object segmentation
    ...
    def __call__(self, text: List[str],
        ...
        #Prepend a 'self.image_seq_length' nuber of image tokens to the prompt
        input_strings = [
